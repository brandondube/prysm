...
def read_mtfmapper_sfr_target(file, pixel_pitch=None):
    """Read an MTF Mapper SFR (MTF) file generated by the -f flag for a target.
    ...
    -------
    `dict`
        dictionary with keys mtf_unit and data.  Data is a list of dicts with
        keys x, y, angle_cart, angle_optical, and mtf
